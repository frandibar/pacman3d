...
private:
    ...
    static const std::string STR_MODERN;
    static const std::string STR_CLASSIC;
    ...
    void addKey(Glib::RefPtr<Gtk::ListStore> &refListStore,const SDLKey &key,const std::string &desc);
